...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void _submitted() async {
    if (_loginformKey.currentState!.validate()) {
      await firebaseAuth
          ...
          .then((auth) async {
        // Check if the user is not belong to app
        ...
        userRef.child(firebaseAuth.currentUser!.uid).once().then((value) async {
          ...
          if (snap.value != null) {
            ...
            await Fluttertoast.showToast(msg: "Succefully logged in");
  ...
  //       DatabaseReference userRef =
  //           FirebaseDatabase.instance.ref().child("acim_user");
  //       userRef.child(currentUser!.uid).once().then((userDataSnapshot) {
  //         if (userDataSnapshot.value != null) {
  //           UserModal userModal = UserModal.fromSnapshot(userDataSnapshot);
  //           String? userRole = userModal.role;

  //           if (userRole == "Car_Mechanic") {
  //             Navigator.pushReplacement(
  //               context,
  ...
  //             Navigator.pushReplacement(
  //               context,
  //               MaterialPageRoute(builder: (context) => const NormUserScreen()),
  //             );
  //           }
  //         }
  //       }).catchError((errorMessage) {
